...
void declareArguments()
{
  ...
  ::arg().set("local-ipv6-udp-fds","A map from addresses in local-ipv6 to inherited UDP file descriptors")="";
  ::arg().set("local-ipv6-tcp-fds","A map from addresses in local-ipv6 to inherited TCP file descriptors")="";
